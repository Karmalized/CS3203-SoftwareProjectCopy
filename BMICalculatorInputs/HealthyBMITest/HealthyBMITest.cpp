...
//THIS AREA IS WHERE ALL THE TESTS WILL BE CREATED FOR THE BMI CALCULATOR
namespace HealthyBMITest
{
	TEST_CLASS(HealthyBMITest)
	{
	public:
		...
		TEST_METHOD(TestWeightGetSet) //Testing the Weight Section of inputs for the BMI & BMR Calculator
		{
			...
			N::BMI_Input Weight; //creates an input object of the BMI_Input class...this will specifically be classified as Weight (as such under specific testing)
			...
			Assert::AreNotEqual(impossibleWeight, Weight.Get_Weight());
